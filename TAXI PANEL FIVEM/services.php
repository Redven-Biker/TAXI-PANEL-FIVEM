...
if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['type'] == "delete") //Checks if it is a delete event.
    {
        ...
        if (!$con->query(
                       "DELETE FROM services WHERE id = ".$con->real_escape_string($_POST['id']))
                       ) 
        {
            echo "Error";
            exit();
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php if ($_SESSION["role"] == "admin") { ?>
                          <a href="add-service"><button type="button" class="btn btn-dark btn-add">Add Service</button></a>
                        <?php } ?>
                      
                        <?php if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['type'] == "delete") //Checks if the law was removed.
                        {?>

                            <?php echo '<div class="alert alert-success" role="alert">Service Deleted</div>'; ?>
...
<table id="myTable">
  ...
  <tr>
    ...
    <td class="center">
    <form method="post">
    <a href="edit-service?id=<?php echo $services['id']; ?>"><button type="button" class="btn btn-dark"><i class="fas fa-edit"></i></button></a>
